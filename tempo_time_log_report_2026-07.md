...
**Status: DRAFT — for your review before syncing to Tempo.** This is a reconstruction, not a record of fact. See "Assumptions & things to double-check" before logging anything.
...
|---|---|---|---|---|---|---|
| **ZOL-5836** | Story / In Progress | 1 | [Track] WLT link forwarding for Production release | 34.25h | 1.00h | **35.25h** |
| **ZOL-7394** | Task / Done | 3 | Add workflows to auto-assign PR reviews (+ Slack digest) | 15.50h | 5.00h | **20.50h** |
| **ZOL-7424** | Story / To Do | 2 | [MyZ][EIP-Cache-01] EIP read cache: Redis client factory refactor + eipCacheClient | 6.75h | 3.50h | **10.25h** |
| **ZOL-6968** | Story / To Do | 3 | [CS][BE-4b] Lazy-upsert auto-provision + GET /cs/me [P1] | 4.25h | 3.25h | **7.50h** |
| **ZOL-6960** | Story / Done | 1 | [MyZ][SPIKE-3] Billing Performance: EIP read caching strategy | 5.50h | 2.50h | **8.00h** |
| **ZOL-6941** | Story / Done | 1 | [MyZ][FE-2] Account Balance: build header from GET /users/eip-details | 4.75h | 2.50h | **7.25h** |
| **ZOL-6961** | Story / To Do | 2 | [MyZ][SPIKE-4] Billing Performance: EIS/EngageIP database indexing | 0.00h | 0.00h | **0.00h** |
| **UNASSIGNED** | — | — | Non-ZOLEO org meetings, no ticket on this Jira site | 0.00h | 1.50h | **1.50h** |
| **TOTAL** | | | | **71.00h** | **19.25h** | **90.25h** |

## Day-by-day detail (ready for Tempo entry, pending your sign-off)

| Date | Ticket | Type | Hours | Notes |
|---|---|---|---|---|
| 2026-07-01 | ZOL-5836 | Dev | 6.25h | Carryover ticket, In Progress, no PR needed / no other ticket evidence this day |
| 2026-07-02 | ZOL-5836 | Dev | 4.50h | Carryover ticket, In Progress, no PR needed / no other ticket evidence this day |
...
| 2026-07-03 | UNASSIGNED | Meeting | 1.00h | Eng Initiatives Sync - FinOps + EngOps — non-ZOLEO/org-wide, no matching ticket |
| 2026-07-03 | ZOL-5836 | Dev | 7.50h | Carryover ticket, In Progress, no PR needed / no other ticket evidence this day |
...
| 2026-07-06 | ZOL-5836 | Dev | 4.75h | Carryover ticket, In Progress, no PR needed / no other ticket evidence this day |
...
| 2026-07-07 | ZOL-5836 | Dev | 6.75h | Carryover ticket, In Progress, no PR needed / no other ticket evidence this day |
...
| 2026-07-07 | ZOL-6968 | Meeting | 0.25h | ZOLEO EPIC's Technical Design's Walkthrough — share by story points 3/10 |
...
| 2026-07-10 | UNASSIGNED | Meeting | 0.50h | Follow up - Service Catalog review for Operation Excellence and FinOps — non-ZOLEO/org-wide |
...
| 2026-07-15 | ZOL-5836 | Dev | 4.50h | Carryover ticket, In Progress, no PR needed / no other ticket evidence this day |
| 2026-07-15 | ZOL-5836 | Meeting | 0.25h | MyZoleo Team Standup — generic, folded pro-rata |
| 2026-07-15 | ZOL-6968 | Dev | 4.25h | PR #855 opened this day; user-directed half day |
...
1. **ZOL-5836 is carrying 35.25h (~4.4 workdays), against 1 story point.** This is the biggest assumption in the report. It's the "no other evidence found" bucket for 2026-07-01, 02, 03, 06, 07, and half of 07-15 — five-plus days with zero PR/Jira trail. You told me it should get "at least 2 days," and this is well past that. Worth sanity-checking against your own memory of those five days — if a chunk of that time actually belongs to work not visible in Jira/GitHub (production support, non-ticketed investigation, etc.), that's consistent with this being a "[Track]" ticket, but 35h logged against a 1-point ticket will look odd to anyone reviewing Tempo.
2. **1.50h `UNASSIGNED`** (Eng Initiatives Sync – FinOps+EngOps on 07-03; Service Catalog review on 07-10) has no home. There's no generic "internal/overhead" project on this Jira site (checked all: ACSP, ISSM, ITHD, ITI, ITIS, NI, PAULAI, TP, ZMA, ZOL) — unlike your old engagement, which had a dedicated `TIME` project (`TIME-32`/`TIME-43`), now inaccessible (404 on this site). You'll need to tell me where this goes, or exclude it from the Tempo sync entirely.
